import { defineComponent, ref, shallowRef, watch, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, nextTick, defineAsyncComponent, computed, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, mergeProps, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, getCurrentScope } from 'vue';
...
import { G as klona, H as defuFn, c as createError$1, I as hasProtocol, J as isScriptProtocol, K as joinURL, L as withQuery, M as sanitizeStatusCode, N as getContext, O as baseURL, P as createHooks, Q as executeAsync, S as withBase, T as destr, U as toRouteMatcher, V as createRouter$1, W as defu } from '../_/nitro.mjs';
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-Bub0zHth.mjs');
...
const unhead_nDS5T1D34jMyvDngultUoMAwnOpFHIGmzaemh_XY_Kw = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./index-DT0hYO1u.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": "auth" } },
    component: () => import('./index-IDEBcbvl.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$b || {},
    component: () => import('./index-C6UcQwqN.mjs')
  },
  {
    name: "dashboard-teams",
    path: "/dashboard/teams",
    meta: __nuxt_page_meta$a || {},
    component: () => import('./index-BRoCtG5J.mjs')
  },
  {
    name: "dashboard-events",
    path: "/dashboard/events",
    meta: __nuxt_page_meta$9 || {},
    component: () => import('./index-mkCOtwn9.mjs')
  },
  {
    name: "dashboard-orders",
    path: "/dashboard/orders",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./index-CchEwdHX.mjs')
  },
  {
    name: "dashboard-company",
    path: "/dashboard/company",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./index-2VFQDjPC.mjs')
  },
  {
    name: "dashboard-tickets",
    path: "/dashboard/tickets",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./index-BxiV_oaP.mjs')
  },
  {
    name: "dashboard-payments",
    path: "/dashboard/payments",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-DZ1lDWHm.mjs')
  },
  {
    name: "dashboard-settings",
    path: "/dashboard/settings",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-CPagg03Z.mjs')
  },
  {
    name: "dashboard-orders-orderId",
    path: "/dashboard/orders/:orderId()",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./_orderId_-CdLM9soB.mjs')
  },
  {
    name: "dashboard-events-create",
    path: "/dashboard/events/create",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./index-B_cV3Gkd.mjs')
  },
  {
    name: "dashboard-events-eventId",
    path: "/dashboard/events/:eventId()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-CRifrVqn.mjs').then((n2) => n2.i)
  },
  {
    name: "dashboard-payments-redirect",
    path: "/dashboard/payments/redirect",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DSrOklNm.mjs')
  }
];
...
const revive_payload_server_oTSWAx_YJz9RT_sGwbLxj6zG7zkZhQxLWDZuW4AYaVI = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./index-Ne2zYMiW.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const plugin_yq3wC3SrlMhsZy3rvkEXTVWgwrIW_5WR4Ies3xihXqY = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
  const { googleSignIn } = (/* @__PURE__ */ useRuntimeConfig()).public;
  if (googleSignIn) {
    const plugin2 = ([__temp, __restore] = executeAsync(() => import('./index.es-CUhaQ1bm.mjs')), __temp = await __temp, __restore(), __temp);
...
const plugin_Rg7GdEqkH6IOzOrXn4mUX2SPzSffJxP5VlREECKihqw = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
    var _a2, _b2;
...
const plugins = [
  unhead_nDS5T1D34jMyvDngultUoMAwnOpFHIGmzaemh_XY_Kw,
  plugin,
  revive_payload_server_oTSWAx_YJz9RT_sGwbLxj6zG7zkZhQxLWDZuW4AYaVI,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  plugin_yq3wC3SrlMhsZy3rvkEXTVWgwrIW_5WR4Ies3xihXqY,
  plugin_Rg7GdEqkH6IOzOrXn4mUX2SPzSffJxP5VlREECKihqw
];
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-DiGcJfEw.mjs').then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import('./dashboard-CIs3U5cT.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-XaXlkLU3.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DyshPD9w.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@netlify+blobs@_5a22c71d37a0a1965be10ff87e4ece93/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@netlify+blobs@_5a22c71d37a0a1965be10ff87e4ece93/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Icon as I, Yr as Y, Zt as Z, __nuxt_component_3 as _, useRoute as a, useNuxtApp as b, useRuntimeConfig as c, defineNuxtRouteMiddleware as d, entry$1 as default, nuxtLinkDefaults as e, useAppConfig as f, getIcon as g, fetchDefaults as h, asyncDataDefaults as i, createError as j, loadIcon as l, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
