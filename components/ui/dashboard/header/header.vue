<template>
  ...
  >
    <div class="app-container flex items-center justify-between">
      <nuxt-link href="/">
        <h3 class="font-semibold uppercase text-primary">Tajamou</h3>
      </nuxt-link>
      <div class="flex items-center justify-start gap-4">
        <nav class="hidden lg:flex item-center justify-center gap-1">
          <nuxt-link
            href="/dashboard"
            class="px-4 py-1.5 text-purple-400 font-semibold text-sm capitalize rounded-full"
            :class="{
      ...
      <div class="flex items-center gap-4">
        ...
        <UiDropdownMenu>
          <UiDropdownMenuTrigger as-child>
            <p
              class="hidden md:inline-block text-sm font-semibold capitalize leading-3 cursor-pointer"
            >
              {{ fullName }}
            </p>
            ...
            />
            <h4
              class="size-10 flex items-center justify-center text-xl font-medium uppercase text-white bg-secondary rounded-full"
            >
